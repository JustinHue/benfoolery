...
?>
<div id="comment-wrapper" class="hide-comments">
	<div id="comment-toggle" onclick="zcommentWrapperClick()">
		<?php comments_number(__( 'Show Comments (0)', 'comicpress' ), __( 'Show Comments (1)', 'comicpress' ), __( 'Show Comments (%)', 'comicpress' )); ?>
	</div>
	<div id="comment-wrapper-inner">
...
<?php } ?>
	...
	<h3 id="comments"><?php comments_number(__( '... 0 Comments ...', 'comicpress' ), __( '... 1 Comments ...', 'comicpress' ), __( '... Comments (%) ...', 'comicpress' )); ?></h3>
